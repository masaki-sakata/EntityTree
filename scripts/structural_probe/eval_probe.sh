...
# layer_list=(0 3 6 9 12 15 18 20 24 28 32)
...
run_one() {
  ...
  local probe_path="../../models/structural_probe/${model}/train250_title/n_comp${probe_rank}/layer${layer}/probe_${probe_type}_layer${layer}_rank${probe_rank}.pt"
  local vis_path="${save_dir}/vis/n_comp${probe_rank}/layer${layer}/vis_layer${layer}_rank${probe_rank}.html"
...
export -f run_one
export model gold_data_path embedding_dir probe_type save_dir device seed
